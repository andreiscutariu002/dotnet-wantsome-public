namespace Threads
{
    ...
    public static class ParamThreadWithTreadPool
    {
        public static void Run()
        {
            ...
            ThreadPool.QueueUserWorkItem(SomeMethod, 0);
            ThreadPool.QueueUserWorkItem(SomeMethod, 10);
            ThreadPool.QueueUserWorkItem(SomeMethod, 20);
